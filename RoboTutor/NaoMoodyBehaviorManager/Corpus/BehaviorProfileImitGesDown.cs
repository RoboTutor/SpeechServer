...
namespace NaoManager
{
    public class BehaviorProfileImitGesDown : BehaviorProfileBase
    {
        ...
        protected override List<double> CoreParameterToJoint(bool right = true)
        {
            ...
            double palmdir       = this.Parameters["PalmDirection"].Value;
            double finger        = this.Parameters["Finger"].Value;
            double headupdown    = this.Parameters["HeadUpDown"].Value;
            double headleftright = this.Parameters["HeadLeftRight"].Value;
            ...
            // [Mandatory] add bias to WristYaw according to PalmDir
            //   This is a simplified version from using NaoJointChain.Arm.OptPalmDirCompEYERWY, which is used in GestUp
